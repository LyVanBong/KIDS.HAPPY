...
using Foundation;
using GMImagePicker;
using KIDS.MOBILE.APP.iOS.Service;
...
namespace KIDS.MOBILE.APP.iOS.Service
{
    public class MultiMediaPickerService : IMultiMediaPickerService
    {
        ...
        {
            ObservableCollection<MediaFile> results = new ObservableCollection<MediaFile>();
            ...
            for (var i = 0; i < args.Assets.Length; i++)
            {
                ...
                switch (asset.MediaType)
                {
                    ...
                    default:
                        ...
                        MessagingCenter.Send<App, ObservableCollection<MediaFile>>((App)Xamarin.Forms.Application.Current, "PickPhotos", results);
                        break;
                }
            }
