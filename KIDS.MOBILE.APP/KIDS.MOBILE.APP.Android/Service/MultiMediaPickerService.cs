...
namespace KIDS.MOBILE.APP.Droid.Service
{
                ...
                if (resultCode == Result.Ok)
                {
                    ...
                    if (data != null)
                    {
                        ...
                        if (clipData != null)
                        {
                            ...
                            MessagingCenter.Send<App, ObservableCollection<MediaFile>>((App)Xamarin.Forms.Application.Current, "PickPhotos", mediaPicked);
                        }
                        else
                        {
